cask "worqer-cli" do
  ...
  on_arm do
    ...
    url "https://github.com/iagorithm/worqer-cli/releases/download/v0.1.0/worqer-cli_0.1.0_darwin_arm64.tar.gz",
        verified: "github.com/iagorithm/worqer-cli/"
  end

  on_intel do
    sha256 "e47d46f0f3da036dd092b7c1239932166737e1381a5d7cafc0ba620512ca15ae"
    url "https://github.com/iagorithm/worqer-cli/releases/download/v0.1.0/worqer-cli_0.1.0_darwin_amd64.tar.gz",
        verified: "github.com/iagorithm/worqer-cli/"
  end

  name "Worqer CLI"
  desc "Operate the Worqer platform from a terminal"
  homepage "https://github.com/iagorithm/worqer-cli"
